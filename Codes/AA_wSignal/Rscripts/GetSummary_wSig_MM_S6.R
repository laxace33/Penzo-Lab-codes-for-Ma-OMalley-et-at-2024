...
outname=paste("MM",didx,id,finf$stype,sep="_")
...
sigsout=apply(getspikes,1,function(s) (y$fscale_base[s[1]:s[2]]))
sigsout=t(sigsout)
...
outhist=paste (paste("summary","MM","perievent_raw",sep="_"),".csv",sep="")
...
outhist=paste (paste("summary","MM","perievent_mean",sep="_"),".csv",sep="")
...
write.csv(cleannames.rfunc(allcue_onset_out),paste (outpath,"summary_MM_allcue_onset.csv",sep=""),row.names=F)

esc_mov_onset_out=data.frame (do.call("rbind",esc_mov_onset_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(esc_mov_onset_out),paste (outpath,"summary_MM_esc_mov_onset.csv",sep=""),row.names=F)

at_esc_out=data.frame (do.call("rbind",at_esc_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(at_esc_out),paste (outpath,"summary_MM_at_esc.csv",sep=""),row.names=F)

at_maxvel_out=data.frame (do.call("rbind",at_maxvel_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(at_maxvel_out),paste (outpath,"summary_MM_at_maxvel.csv",sep=""),row.names=F)

cue_freeze_out=data.frame (do.call("rbind",cue_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(cue_freeze_out),paste (outpath,"summary_MM_cue_freeze.csv",sep=""),row.names=F)

post_esc_freeze_out=data.frame (do.call("rbind",post_esc_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(post_esc_freeze_out),paste (outpath,"summary_MM_post_esc_freeze.csv",sep=""),row.names=F)

fast_esc_cue_freeze_out=data.frame (do.call("rbind",fast_esc_cue_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(fast_esc_cue_freeze_out),paste (outpath,"summary_MM_fast_esc_cue_freeze.csv",sep=""),row.names=F)

slow_esc_cue_freeze_out=data.frame (do.call("rbind",slow_esc_cue_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(slow_esc_cue_freeze_out),paste (outpath,"summary_MM_slow_esc_cue_freeze.csv",sep=""),row.names=F)

fast_esc_freeze_out=data.frame (do.call("rbind",fast_esc_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(fast_esc_freeze_out),paste (outpath,"summary_MM_fast_esc_freeze.csv",sep=""),row.names=F)

slow_esc_freeze_out=data.frame (do.call("rbind",slow_esc_freeze_out),stringsAsFactors=F)
write.csv(cleannames.rfunc(slow_esc_freeze_out),paste (outpath,"summary_MM_slow_esc_freeze.csv",sep=""),row.names=F)
...
outheat_1=paste (paste("summary","MM","heat_matrix_noshock",sep="_"),".csv",sep="")
...
outheat_2=paste (paste("summary","MM","heat_matrix_shock",sep="_"),".csv",sep="")
