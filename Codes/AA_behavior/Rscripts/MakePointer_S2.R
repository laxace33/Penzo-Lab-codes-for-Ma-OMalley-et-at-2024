root="//eu.boehringer.com/users/bib/users1/duhoffma/Desktop/AA_pipeline/aa_test/"  #this is the root folder
...
out=c(as.character (edate),vidname,rep(NA,6),tfiles[i],am)
...
write.csv(bigout,file=paste(fnameout,"pointer.csv",sep="/"),row.names=F)
